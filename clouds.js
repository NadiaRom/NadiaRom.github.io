...
var windowHalfY = $('#header-lead').height() / 2;

init();

function init() {

    container = document.getElementById('header-lead');
...
function onWindowResize( event ) {
    ...
    camera.aspect = window.innerWidth / $('#header-lead').height() ;
    camera.updateProjectionMatrix();

    renderer.setSize( window.innerWidth, $('#header-lead').height() );
